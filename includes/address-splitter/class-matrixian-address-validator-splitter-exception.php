 ...
 */
class Matrixian_Address_Validator_Splitter_Exception extends \InvalidArgumentException
{
    ...
    /**
     * Create new Matrixian_Address_Validator_Splitter_Exception, automatically adds a meaningful error message when the error code is known.
     *
     * @param int $code
